...
const industries = [
    ...
    { name: "Track Mounted 811 S", link: "/products/mobileseries/jaw811s" },
    ...
    <>
      ...
      <section className="py-20 px-6 bg-gray-100 text-black flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2">
          ...
          Track Mounted Jaw 811
          </h2>
          <p className="text-base text-black mb-6">
         The elevated mouth opening of the TMJ Series single toggle Jaw Crushers ensure significant production saving by eliminating frequent bridging of stone in feed opening. Optimum jaw nip angle reduces laminar product shape, ensures even manganese wear-off with increasing production. Hefty’s track mounted mobile jaw crushers become an extension of your workflow, seamlessly integrating into your existing systems and empowering you to optimize production, wherever your work takes you.
          </p>
