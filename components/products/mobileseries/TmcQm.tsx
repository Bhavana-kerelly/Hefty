    ...
    <>
      ...
      <section className="py-20 px-6 bg-gray-100 text-black flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2">
         ...
         Track Mounted Cone – QM Series
          </h2>
          <p className="text-base text-black mb-6">
         Hefty TMC Series feature a unique combination of crusher speed, throw and cavity design. This combination is known for its revolutionary higher capacity and better product quality. It has been designed to ensure trouble-free operation in heavy and continuous applications.
          </p>
