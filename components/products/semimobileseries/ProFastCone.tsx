...
const industries = [
    { name: "PROFAST CONE PRFMQ SERIES", link: "#products/crushers/ccavcseries" },
    { name: "PROFAST CONE PRFMC SERIES", link: "#products/crushers/ccqmseries" },
